...
function searchBook(){
    ...
    if(event.keyCode ==13){
        ...
        $.ajax({
            // url : 서버 프로그램에 대한 url
            url:"http://localhost:7070/book/rentbookList",
            // type: 전송방식
            type: "GET",
...
$(function(){
    ...
    $(document).on("click","#rent",function(){
        ...
        $.ajax({
            // url : 서버 프로그램에 대한 url
            url:"http://localhost:7070/book/rentbookupdate",
            // type: 전송방식
            type: "GET",
            // 만약 서버쪽에서 보내주는 데이터가 JSON이면
            ...
            success : function(result){
                ...
                if(result==true){
                    ...
                    alert("더 이상 대여가 불가능합니다.!! 대여 중인 도서를 반납하세요");
                }
    ...
    $(document).on("click","#return",function(){
        ...
        $.ajax({
            // url : 서버 프로그램에 대한 url
            url:"http://localhost:7070/book/returnbookupdate",
            // type: 전송방식
            type: "GET",
            // 만약 서버쪽에서 보내주는 데이터가 JSON이면
